...
FRASES_MORTE = [
    ...
    "Você aceitou um drink misterioso enviado por {assassino}. Tinha gosto de amêndoas... e fim.",
...
MAPA.add_row('Restaurante', 'Piscina Principal', '[yellow]Bar do Convés')
...
def main():
    ...
    while True:
        ...
        while not assassino_descoberto:
            ...
            stats_table.add_column("Chance de Pista", justify="center", style="green")
            stats_table.add_column("Risco de Morte", justify="center", style="red")
            ...
            if dia == TOTAL_DE_DIAS - 1:
                c.print(Panel(
                    'O cruzeiro atracou no porto! A multidão permitiu que o assassino fugisse no meio da confusão.',
                    title="[bold red]FIM DO PRAZO[/]", style="red on black"), justify='center')
                break
            ...
            if acao == 0:
                ...
                match resultado:
                    ...
                    case 'MORTE':
                        ...
                        c.print(Panel(
                            ...
                            title="GAME OVER", border_style="red", box=box.HEAVY_EDGE, padding=(2, 5), justify="center"
                        ))
                    case 'NADA':
                ...
                if 0 <= indice_assasino_palpite < len(PERSONAGENS):
                    ...
                    if assassino_palpite == assassino:
                        assassino_descoberto = True
                        pontuacao = PONTUACAO_MAXIMA * (1 / dia)
                        c.print(Panel(f'\n[bold green]PARABÉNS, DETETIVE![/]\n\nVocê encurralou {assassino} e obteve uma confissão!\nO mistério do cruzeiro foi resolvido.\n\n[bold yellow]Pontuação Final: {pontuacao:.0f}/{PONTUACAO_MAXIMA}[/]\n', title="VITÓRIA", border_style="bright_green", box=box.DOUBLE, padding=(2,5)), justify="center")
                    else:
        ...
        if not assassino_descoberto:
            c.print(f'O assassino era o {assassino}!')
            c.print('Fim de jogo!')
