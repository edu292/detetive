...
ARMAS = ['Faca', 'Garrafa de Champagne', 'Veneno', 'Taco de Sinuca', 'Peça de Diamante', 'Corrente de Ouro']
LUGARES = ['Quarto do Ney', 'Quarto do Vini', 'Quarto da Ana Castela', 'Restaurante', 'Piscina Principal', 'Bar do Convés', 'Salão de Jogos', 'Banheiros', 'Deck']
...
ACOES_INVESTIGACAO = [
    'Hackeando o histórico de localização dos smartwatches dos convidados...',
    'Passando o scanner de luz negra no sofá de veludo...',
    'Subornando o garçom com uma gorjeta em Euro...',
    'Verificando as câmeras de segurança do corredor...',
    'Ouvindo fofocas no corredor...',
    'Analisando os stories dos convidados...'
]
...
FRASES_NADA = [
    ...
    'A equipe de limpeza já passou por aqui. Nada útil.'
]

FRASES_BARRADO = [
    'A assessoria do Neymar te parou: "Você está cortando a vibe do cruzeiro. Chega por hoje."',
    'O "Parça" chefe te barrou: "O pai tá on, mas você tá off. Circulando!"',
...
FRASES_MORTE = [
    ...
    'Um drone de filmagem "perdeu o controle" e atingiu sua cabeça. {assassino} estava com o controle remoto.',
    'Você aceitou um drink misterioso enviado por {assassino}... fim.',
    '{assassino} te convidou para uma selfie na beira do convés. O empurrão foi "acidental", a queda não.',
...
def carregar_cenario():
    ...
    arma_crime = random.choice(ARMAS)
    contexto = (
